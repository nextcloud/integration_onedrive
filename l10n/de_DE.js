OC.L10N.register(
    ...
    "OneDrive" : "OneDrive",
    "_%s file was imported from Onedrive storage._::_%s files were imported from Onedrive storage._" : ["%s Datei wurden vom Onedrive -Speicher importiert.","%s Dateien wurden vom Onedrive -Speicher importiert."],
    ...
    "Put the OAuth app \"Client ID\" and \"Client secret\" below." : "Unten \"Client ID\" und \"Client secret\" der OAuth-App eingeben.",
    ...
    "Client secret of your OneDrive application" : "Client-Geheimnis Ihrer OneDrive-Anwendung",
    ...
    "Ask your Nextcloud administrator to configure OneDrive OAuth settings in order to use this integration." : "Bitten Sie IhreNextcloud-Administration, die OneDrive-OAuth-Einstellungen zu konfigurieren, um diese Integration verwenden zu können.",
    ...
    "Import Contacts in Nextcloud" : "Kantakte nach Nextcloud importieren",
    "Calendars" : "Kalender",
