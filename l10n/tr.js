OC.L10N.register(
    ...
    "OneDrive" : "OneDrive",
    "_%n file was imported from OneDrive storage._::_%n files were imported from OneDrive storage._" : ["%n dosya OneDrive depolamasından içe aktarıldı.","%n dosya OneDrive depolamasından içe aktarıldı."],
    ...
    "Give the \"Contacts.Read\", \"Calendars.Read\", \"MailboxSettings.Read\", \"Files.Read\" and \"User.Read\" API permission to your app." : "Uygulamanıza \"Contacts.Read\", \"Calendars.Read\", \"MailboxSettings.Read\", \"Files.Read\" ve \"User.Read\" API izinlerini verin.",
    ...
    "OneDrive storage" : "OneDrive depolama alanı",
    "Import directory" : "İçe klasör aktar",
    "OneDrive storage ({formSize})" : "OneDrive depolama alanı ({formSize})",
